...
| Conjunto de categorias padrão | Saída (17): Alimentação, Moradia, Transporte, Saúde, Educação, Lazer, Vestuário, Assinaturas e serviços, Aluguel, Investimentos, Conta de água, Conta de luz, Financiamento, Dívidas, Cartão de crédito, Boletos, Outros. Entrada (6): Salário, Renda extra, Investimentos, Aluguel, Pagamentos, Outros | Cobertura típica de finanças pessoais BR sem excesso; "Outros" garante que nenhuma transação fica sem categoria possível. Usuário aprovou o conjunto original em 2026-07-18; revisado em 2026-07-19 após feedback pós-lançamento pedindo categorias adicionais (Aluguel e Investimentos nos dois tipos, Pagamentos, contas de água/luz, financiamento, dívidas, cartão de crédito, boletos) — criação de personalizadas segue disponível (story P1) | y |
