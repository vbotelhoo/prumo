...
| -------------- | ----- | ----- | ------ |
| SHELL-01 | P1: Navegação global | Execute (T3, T5) | ✅ Verified |
| SHELL-02 | P1: Navegação global | Execute (T5) | ✅ Verified |
| SHELL-03 | P1: Navegação global | Execute (T3, T5) | ✅ Verified |
| SHELL-04 | P1: Navegação global | Execute (T5) | ✅ Verified |
| SHELL-05 | P1: Sessão e logout | Execute (T5) | ✅ Verified |
| SHELL-06 | P1: Sessão e logout | Execute (T5) | ✅ Verified |
| SHELL-07 | P1: Sessão e logout | Execute (T5) | ✅ Verified |
| SHELL-08 | P1: Shell responsivo | Execute (T6) | ✅ Verified |
| SHELL-09 | P1: Shell responsivo | Execute (T6) | ✅ Verified |
| SHELL-10 | P1: Shell responsivo | Execute (T6) | ✅ Verified |
| SHELL-11 | P1: Shell responsivo | Execute (T6) | ✅ Verified |
| SHELL-12 | P1: Fundação de design | Execute (T9) | ✅ Verified |
| SHELL-13 | P1: Fundação de design | Execute (T1) | ✅ Verified |
| SHELL-14 | P1: Fundação de design | Execute (T1, T8) | ✅ Verified |
| SHELL-15 | P2: Acessibilidade | Execute (T5) | ✅ Verified |
| SHELL-16 | P2: Acessibilidade | Execute (T5) | ✅ Verified |
| SHELL-17 | Edge case (nome longo) | Execute (T5) | ✅ Verified |
| SHELL-18 | P1: Dark mode | Execute (T2, T7) | ✅ Verified |
| SHELL-19 | P1: Dark mode | Execute (T7) | ✅ Verified |
| SHELL-20 | P1: Dark mode | Execute (T2, T7) | ✅ Verified |
| SHELL-21 | P1: Dark mode | Execute (T7) | ✅ Verified |

**Coverage:** 21 total, 21 mapped to tasks (T1–T9 em `tasks.md`), 0 unmapped ✅
**Status**: ✅ Verificado (PASS) — ver `.specs/features/app-shell/validation.md`. SHELL-15 verificado com uma nota de cobertura (comportamento correto por implementação, sem asserção e2e dedicada para alcançabilidade por Tab dos 5 itens); não bloqueia o PASS.
