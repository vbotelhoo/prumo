...
import { NAV_ITEMS, isActive } from "../_lib/nav";
...
// SHELL-01..07, SHELL-15..17). Sidebar fixa aqui (T5); topbar+drawer <lg
// entram em T6, ThemeToggle em T7 — mesmo componente, estendido em fases.
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col">
      ...
      <div className="flex min-h-full flex-1">
                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      className={
                        active
                          ? `${NAV_LINK_CLASSES} bg-sidebar-accent text-sidebar-primary`
                          : NAV_LINK_CLASSES
                      }
                    >
                      {item.label}
        ...
        focável programaticamente — <main> não é focável por padrão, e sem
        isso ativar o link rola a página mas não move o foco do teclado. */}
